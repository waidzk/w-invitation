      ...
      <div className="absolute top-0 w-full h-full z-100">
        <div className="flex flex-col justify-center p-6">
          <div className="bg-white/40 backdrop-blur-xs rounded-2xl flex flex-col items-center justify-center h-[calc(100vh-100px)]">
            ...
            <a href="https://maps.app.goo.gl/phnPmHZr5NhfpoW66" className="px-5 py-2 bg-[#AA873C] text-white rounded-full mt-4">Buka Google Maps</a>
          </div>
        </div>
      </div>
      <MockNav prevPage="/event" nextPage="/gallery" />
    </div>
  );
}
