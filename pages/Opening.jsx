...
function Opening() {
  ...
  return (
    <div className="relative overflow-hidden max-w-[450px] w-full h-[100dvh] bg-slate-100 bg-[url(/images/layer.png)] bg-cover">
      <Decoration />
      <div className="flex flex-col justify-center items-center w-full h-full text-[#AA873C] transition">
        ...
        <div className="flex flex-col items-center javassoul mb-10">
          <h1 className="text-6xl sm:text-7xl">Adam</h1>
          <h2 className="text-3xl">&</h2>
          <h1 className="text-6xl sm:text-7xl">Aisha</h1>
        </div>
