...
import coupleImage from "/images/Foto Greetings.jpg";
    ...
    <div className="relative overflow-hidden max-w-[450px] w-full h-[100dvh] bg-slate-100 bg-[url(/images/layer.png)] bg-cover bg-left">
      ...
      <div className="flex flex-col items-center justify-center w-full h-full text-[#AA873C] transition">
        ...
        <div className='mt-6 w-40 md:w-48 pb-20 transition-from-bottom'>
          <p className='text-center text-[10px] md:text-xs'>Om Swastiastu</p>
          <p className='text-center text-xs md:text-sm font-light'>Tanpa mengurangi rasa hormat, kami bermaksud mengundang Bapak/Ibu/Saudara/i pada acara resepsi pernikahan putra putri kami</p>
        </div>
      </div>
    </div>
  )
